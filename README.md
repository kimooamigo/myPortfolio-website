...
![AMEGOFY | Personal Porfolio Website Template](public/social_img.webp)

AMEGOFY is a free and open-source template for your Personal Portfolio Website built with Astro and TailwindCSS. Create in minutes a website with a Blog, CV, Project Section, Store, and RSS Feed.

## Demo

View a live demo of [AMEGOFY](https://kemooamegoo.great-site.net/)
...
- **GENERATE_SLUG_FROM_TITLE**: By default AMEGOFY will generate the blog slug pages base on the article name. Set this var to false if you want to use the Astro file base (Compatible with AMEGOFY older versions).
...
One of the best ways to contribute is to grab a [bug report or feature suggestion](https://github.com/manuelernestog/AMEGOFY/issues) that has been marked `accepted` and dig in.
